...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //
     [WIN] = LAYOUT(
        ...
        SC_LCPO,         KC_LGUI,    KC_LALT,                   KC_SPC,                             KC_RALT, MO(FN),  SC_RCPC,                                              KC_LEFT, KC_DOWN, KC_RGHT
    ),
     ...
     [MAC] = LAYOUT(
        ...
        HYPR_T(KC_CAPS), KC_A,       KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,                                  KC_ENT,                       KC_PGDN,
        SC_LSPO,         KC_Z,       KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                                           SC_RSPC,             KC_UP,   KC_END,
        SC_LCPO,         KC_LALT,    KC_LGUI,                   KC_SPC,                             KC_RALT, MO(FN),  SC_RCPC,                                              KC_LEFT, KC_DOWN, KC_RGHT
    ),
