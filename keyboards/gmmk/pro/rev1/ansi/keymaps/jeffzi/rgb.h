...
#    define RGB_TEST4 \
        0xFF, 0xB0, 0x00 // R - yellow    slightly green heavy - reduced green LED by
                         // quite a bit
...
#    define RGB_TEST10 \
        0x00, 0xFF, 0x10 // P - springgrn fixed: was too blue because green LED has blue
                         // in it already
...
const uint8_t LED_WASD[]     = {LED_W, LED_A, LED_S, LED_D};
const uint8_t LED_CAPSLOCK[] = {
...
const uint8_t LED_FUNCROW[] = {LED_ESC, LED_F1,  LED_F2,  LED_F3, LED_F4,
                               LED_F5,  LED_F6,  LED_F7,  LED_F8, LED_F9,
                               LED_F10, LED_F11, LED_F12, LED_INS};

const uint8_t LED_NUMROW[] = {LED_GRV, LED_1,    LED_2,   LED_3,    LED_4,
                              LED_5,   LED_6,    LED_7,   LED_8,    LED_9,
                              LED_0,   LED_MINS, LED_EQL, LED_BSPC, LED_DEL};

const uint8_t LED_LETTERS[] = {LED_Q, LED_W, LED_E, LED_R, LED_T, LED_Y, LED_U,
                               LED_I, LED_O, LED_P, LED_A, LED_S, LED_D, LED_F,
                               LED_G, LED_H, LED_J, LED_K, LED_L, LED_Z, LED_X,
                               LED_C, LED_V, LED_B, LED_N, LED_M};

const uint8_t LED_NUMPAD[] = {
    LED_1, LED_2,    LED_3,   LED_4, LED_5,    LED_6,   LED_7,    LED_8,   LED_9,
    LED_0, LED_MINS, LED_EQL, LED_U, LED_I,    LED_O,   LED_P,    LED_J,   LED_K,
    LED_L, LED_SCLN, LED_ENT, LED_M, LED_COMM, LED_DOT, LED_SLSH, LED_END, LED_RIGHT};

const uint8_t LED_SIDE_LEFT[] = {LED_L1, LED_L2, LED_L3, LED_L4,
                                 LED_L5, LED_L6, LED_L7, LED_L8};

const uint8_t LED_SIDE_RIGHT[] = {LED_R1, LED_R2, LED_R3, LED_R4,
